...
const TextType = ({
  ...
  // Cursor blink is handled via CSS animation — no GSAP needed
  ...
  return createElement(
    ...
    showCursor && (
      <span
        ref={cursorRef}
        className={`ml-1 inline-block ${shouldHideCursor ? "hidden" : "animate-[blink_1s_step-end_infinite]"} ${cursorClassName}`}
